...
def select_series_title_with_most_human_characters
  "select series.title from characters inner join series on characters.series_id = series.id group by (count(characters.species)) having characters.species = 'human';"
end
